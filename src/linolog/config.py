...
class Config:
    ...
    ENABLE_TOOLS_NORMALIZER = os.getenv('ENABLE_TOOLS_NORMALIZER', 'true').lower() == 'true'
    
    # LLM Configuration
    ENABLE_LLM = os.getenv('ENABLE_LLM', 'false').lower() == 'true'
    LLM_PROVIDER = os.getenv('LLM_PROVIDER', 'anthropic')  # 'openai' or 'anthropic'
    ENABLE_LLM_COLOR_AGENT = os.getenv('ENABLE_LLM_COLOR_AGENT', 'true').lower() == 'true'
    ...
    REQUIRED_FIELDS = [
        'title', 'date', 'edition', 'size', 'medium', 
        'paper_type', 'blocks_used'
    ]
