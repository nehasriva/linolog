        ...
        try:
            ...
            with Image.open(image_path) as img:
                ...
                while True:
                    ...
                    resized_img.save(img_bytes, format='JPEG', quality=quality, optimize=True)
                    ...
                    if compressed_size <= max_size or quality <= 10:
                        # Encode to base64
                        img_bytes.seek(0)
                        encoded_string = base64.b64encode(img_bytes.read()).decode('utf-8')
                        print(f"      ✅ Final size: {compressed_size} bytes (under 5MB limit)")
                        return encoded_string
                    ...
                    if quality > 10:
                        ...
                        print(f"      📐 Reducing size to: {current_width}x{current_height}")
